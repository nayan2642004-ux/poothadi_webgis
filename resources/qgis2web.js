...
map.getView().fit([8467698.641269, 1302641.230938, 8498610.496667, 1328683.700492], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">poothadi_webgis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (77 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'part of my msc programthe software was created using an open software program';
            }
